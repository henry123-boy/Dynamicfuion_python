...
def cuda_warp_and_project_voxel_centers(intrinsic_matrix, camera_rotation, camera_translation,
...
def cuda_compute_psdf_warped_voxel_centers_kernel(psdf,
    ...
    du, dv, _, _, warped_voxel_z = \
        cuda_warp_and_project_voxel_centers(intrinsic_matrix, camera_rotation, camera_translation,
                                            voxel_centers, voxel_center_anchors, voxel_center_weights,
...
@cuda.jit()
def cuda_update_warped_voxel_center_tsdf_and_weights_kernel(weights_and_tsdf, cos_voxel_ray_to_normal, truncation_distance,
...
def cuda_update_warped_voxel_center_tsdf_and_weights(
    ...
    cuda_update_warped_voxel_center_tsdf_and_weights_kernel[cuda_grid_size, cuda_block_size](
