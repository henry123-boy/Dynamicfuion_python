...
def main():
    ...
    def rotate_cube(angle: float) -> o3d.geometry.TriangleMesh:
        ...
        mesh = o3d.t.geometry.TriangleMesh.from_legacy_triangle_mesh(original_mesh, device=device)
    ...
    for i_frame in range(0, frame_count):
        i_angle = math.radians(rotation_increment * i_frame)
        rotated_mesh = rotate_cube(i_angle)
