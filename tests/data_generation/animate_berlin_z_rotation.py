...
import data.camera
from settings import process_arguments, DeformNetParameters, PathParameters
...
def main():
    ...
    # prepare folders
    root_output_directory = os.path.join(PathParameters.output_directory.value, "berlin_z_rotation_sequence")
