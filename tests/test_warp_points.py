...
import nnrt.geometry.functional as ngf
...
def test_warp_points_cpp_vs_legacy():
    ...
    warped_pc_o3d = ngf.warp_point_cloud(pc, nodes_o3d, node_rotations_o3d, node_translations_o3d, point_anchors_o3d, point_weights_o3d, 4)
