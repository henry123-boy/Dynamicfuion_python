...
def test_compute_anchors_euclidean_nnrtf_vs_legacy_nnrt_cpp(device):
    ...
    vertex_anchors, vertex_weights = nnrt.geometry.functional.compute_anchors_and_weights_euclidean_fixed_node_weight(points_o3d, nodes_o3d,
                                                                                         anchor_count, 0, 0.5)
...
def test_shortest_path_anchors(device: o3d.core.Device):
    ...
    anchors, weights = nnrt.geometry.functional.compute_anchors_and_weights_shortest_path_fixed_node_weight(
...
def test_compute_anchors_shortest_path_nnrtf_vs_legacy_nnrt_cpp(device):
    ...
    vertex_anchors, vertex_weights = \
        nnrt.geometry.functional.compute_anchors_and_weights_shortest_path_fixed_node_weight(vertices_o3d, nodes_o3d, edges_o3d,
