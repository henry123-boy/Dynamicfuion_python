...
def load_open3d_intrinsics_from_text_4x4_matrix_and_image(path_matrix: str, path_image: str) -> Tuple[o3d.camera.PinholeCameraIntrinsic, np.ndarray]:
    intrinsic_matrix = np.loadtxt(path_matrix)
    fx = intrinsic_matrix[0, 0]
    fy = intrinsic_matrix[1, 1]
    cx = intrinsic_matrix[0, 2]
    ...
    return o3d.camera.PinholeCameraIntrinsic(width, height, fx, fy, cx, cy), intrinsic_matrix
