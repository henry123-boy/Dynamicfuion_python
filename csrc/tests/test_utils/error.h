    ...
    private:
        ...
        void check_for_previous_fatal_errors()
        {
            ...
            else
            {
                ...
                // set this termination handler so that if the user doesn't catch this test::fatal_error that is being
...
class impossible_labeling_error : public error
    { 
        ...
        !*/
    public: 
        impossible_labeling_error(const std::string& msg) : test::error(msg) {};
    };
