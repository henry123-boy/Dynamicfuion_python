...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            // you can only assign vectors with 3 elements to a test::vector<T,3> object
        ...
        {
            test::exchange(x(), item.x());
	        test::exchange(y(), item.y());
	        test::exchange(z(), item.z());
        }
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        {
            // you can only assign vectors with 2 elements to a test::vector<T,2> object
...
namespace std
{
    ...
    !*/
    template<typename T>
    struct less<test::vector<T,3> >
    {
        typedef test::vector<T, 3> first_argument_type;
        typedef test::vector<T, 3> second_argument_type;
        typedef bool result_type;
        inline bool operator() (const test::vector<T,3> & a, const test::vector<T,3> & b) const
        { 
    ...
    !*/
    template<typename T>
    struct less<test::vector<T,2> >
    {
        typedef test::vector<T, 2> first_argument_type;
        typedef test::vector<T, 2> second_argument_type;
        typedef bool result_type;
        inline bool operator() (const test::vector<T,2> & a, const test::vector<T,2> & b) const
        { 
            if      (a.x() < b.x()) return true;
            else if (a.x() > b.x()) return false;
            else if (a.y() < b.y()) return true;
