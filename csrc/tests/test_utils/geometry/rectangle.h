...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        inline bool operator< (const test::rectangle& b) const
        { 
...
// ----------------------------------------------------------------------------------------
    ...
    inline test::vector<double,2> dcenter (
        const test::rectangle& rect
    )
    {
        test::vector<double,2> temp(rect.left() + rect.right(),
...
// ----------------------------------------------------------------------------------------
    ...
    template <typename T>
    inline const test::vector<T,2> nearest_point (
        const rectangle& rect,
        const test::vector<T,2>& p
    )
    {
        test::vector<T,2> temp(p);
        if (temp.x() < rect.left())
            temp.x() = rect.left();
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        else
        {
            ...
            const test::vector<T,2> c1 = alpha1*d + p2;
            const test::vector<T,2> c2 = alpha2*d + p2;
            const test::vector<T,2> c3 = alpha3*d + p2;
            const test::vector<T,2> c4 = alpha4*d + p2;
