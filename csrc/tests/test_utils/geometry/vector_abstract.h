...
namespace std
{
    ...
    !*/
    template<typename T>
    struct less<test::vector<T,3> > : public binary_function<test::vector<T,3> ,test::vector<T,3> ,bool>
    {
    ...
    !*/
    template<typename T>
    struct less<test::vector<T,2> > : public binary_function<test::vector<T,2> ,test::vector<T,2> ,bool>
    {
