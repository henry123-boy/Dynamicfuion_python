...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        for (long r = 0; r < m.nr(); ++r)
        {
            ...
            {
                type temp = m(r,c);
                if (test::impl::magnitude(temp) > test::impl::magnitude(max_val))
                    max_val = temp;
                if (test::impl::magnitude(temp) < test::impl::magnitude(min_val))
                    min_val = temp;
            }
        }
    }
...
// ----------------------------------------------------------------------------------------
    ...
    )
    {
        ...
        for (long r = 0; r < m.nr(); ++r)
        {
            ...
            {
                type temp = m(r,c);
                if (test::impl::magnitude(temp) > test::impl::magnitude(val))
                {
                    val = temp;
