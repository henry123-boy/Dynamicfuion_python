...
namespace test
{
    ...
    public:
        ...
        /*!
            ensures
                ...
                - for test::array2d objects, the returned value
                  is always equal to sizeof(type)*nc().  However,
                  other objects which implement test::array2d style
                  interfaces might have padding at the ends of their
                  rows and therefore might return larger numbers.
                  An example of such an object is the test::cv_image.
        !*/
    ...
    /*!
        ...
        test::matrix and test::array2d objects are compatible.  That means you can load the
