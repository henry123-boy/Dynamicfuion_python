...
template
void IntegrateWarpedDQ<AnchorComputationMethod::EUCLIDEAN, o3c::Device::DeviceType::CPU>(
...
template
void IntegrateWarpedDQ<AnchorComputationMethod::SHORTEST_PATH, o3c::Device::DeviceType::CPU>(
		const open3d::core::Tensor& block_indices, const open3d::core::Tensor& block_keys, open3d::core::Tensor& block_values,
		open3d::core::Tensor& cos_voxel_ray_to_normal, int64_t block_resolution, float voxel_size,
		float sdf_truncation_distance,
		const open3d::core::Tensor& depth_tensor, const open3d::core::Tensor& color_tensor,
...
template
void IntegrateWarpedMat<AnchorComputationMethod::EUCLIDEAN, o3c::Device::DeviceType::CPU>(
		const open3d::core::Tensor& block_indices, const open3d::core::Tensor& block_keys, open3d::core::Tensor& block_values,
		open3d::core::Tensor& cos_voxel_ray_to_normal, int64_t block_resolution, float voxel_size,
		float sdf_truncation_distance,
		const open3d::core::Tensor& depth_tensor, const open3d::core::Tensor& color_tensor,
...
template
void IntegrateWarpedMat<AnchorComputationMethod::SHORTEST_PATH, o3c::Device::DeviceType::CPU>(
		const open3d::core::Tensor& block_indices, const open3d::core::Tensor& block_keys, open3d::core::Tensor& block_values,
		open3d::core::Tensor& cos_voxel_ray_to_normal, int64_t block_resolution, float voxel_size,
		float sdf_truncation_distance,
		const open3d::core::Tensor& depth_tensor, const open3d::core::Tensor& color_tensor,
