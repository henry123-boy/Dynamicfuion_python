...
RasterizeMesh(const open3d::core::Tensor& normalized_camera_space_face_vertices, std::tuple<int64_t, int64_t> image_size,
	...
	if (faces_per_pixel > kernel::max_points_per_pixel) {
...
open3d::core::Tensor ExtractClippedFaceVerticesInNormalizedCameraSpace(
	...
	if (near_clipping_distance < kernel::min_near_clipping_distance) {
		o3u::LogError("near_clipping_distance cannot be less than {}. Got {}.", kernel::min_near_clipping_distance, near_clipping_distance);
	}
