...
template<open3d::core::Device::DeviceType TDeviceType, typename TRunBeforeReturnInvalid, typename TGetOutputIndex>
	...
	o3c::ParallelFor(
			...
			NNRT_LAMBDA_CAPTURE_CLAUSE NNRT_DEVICE_WHEN_CUDACC(int64_t workload_idx) {
				...
				if (!have_vertex_within_clipping_range) {
					run_before_return_invalid(workload_idx);
					return;
				}
				...
				auto output_face_index = get_output_face_index(workload_idx);
...
void ExtractClippedFaceVerticesInNormalizedCameraSpace(open3d::core::Tensor& vertex_positions_normalized_camera,
                                                       const open3d::core::Tensor& vertex_positions_camera,
                                                       const open3d::core::Tensor& triangle_vertex_indices,
                                                       const open3d::core::Tensor& normalized_camera_space_matrix,
                                                       kernel::AxisAligned2dBoundingBox normalized_camera_space_xy_range,
	...
	ExtractClippedFaceVerticesInNormalizedCameraSpace_Generic<TDeviceType>(
			vertex_positions_normalized_camera, vertex_positions_camera, triangle_vertex_indices, normalized_camera_space_matrix,
