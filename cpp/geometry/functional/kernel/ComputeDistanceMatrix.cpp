...
void ComputeDistanceMatrix(open3d::core::Tensor& distance_matrix, const open3d::core::Tensor& point_set1, const open3d::core::Tensor& point_set2){
	core::ExecuteOnDevice(
			point_set1.GetDevice(),
			[&]{
				ComputeDistanceMatrix<open3d::core::Device::DeviceType::CPU>(distance_matrix, point_set1, point_set2);
			},
			[&]{
				NNRT_IF_CUDA(ComputeDistanceMatrix<open3d::core::Device::DeviceType::CUDA>(distance_matrix, point_set1, point_set2););
			}
	);
}
