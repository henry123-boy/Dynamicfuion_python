...
template void MeshVerticesClippedToNdcSpace<open3d::core::Device::DeviceType::CPU>(
...
template void MeshDataAndClippingMaskToNdcSpace<open3d::core::Device::DeviceType::CPU>(open3d::core::Tensor& vertex_positions_normalized_camera,
