...
template void MeshVerticesClippedToNormalizedCameraSpace<open3d::core::Device::DeviceType::CPU>(
...
template void MeshDataAndClippingMaskToRaySpace<open3d::core::Device::DeviceType::CPU>(open3d::core::Tensor& vertex_positions_normalized_camera,
