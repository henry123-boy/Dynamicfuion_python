...
template void MeshVerticesClippedToNdc<open3d::core::Device::DeviceType::CUDA>(
...
template void MeshDataAndClippingMaskToNdc<open3d::core::Device::DeviceType::CUDA>(open3d::core::Tensor& vertex_positions_normalized_camera,
