...
public:
	...
	entropy_range_decoder ();

	entropy_range_decoder(entropy_range_decoder&) = delete;
	entropy_range_decoder& operator=(entropy_range_decoder&) = delete;

	virtual ~entropy_range_decoder () = default;
	...
	bool get_target_called () const;

	uint32 get_target (uint32 total);
