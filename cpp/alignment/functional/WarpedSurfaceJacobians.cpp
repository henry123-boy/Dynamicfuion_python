...
WarpedSurfaceJacobians(
	...
	kernel::WarpedSurfaceJacobians(warped_vertex_jacobians, warped_normal_jacobians, canonical_mesh.GetVertexPositions(),
	                               canonical_mesh.GetVertexNormals(), warp_field.GetNodePositions(use_virtual_ordering),
	                               warp_field.GetNodeRotations(use_virtual_ordering), warp_anchors, warp_anchor_weights, false);
...
open3d::core::Tensor WarpedVertexRotationJacobians(
	...
	kernel::WarpedSurfaceJacobians(warped_vertex_jacobians, utility::nullopt, canonical_mesh.GetVertexPositions(),
	                               utility::nullopt, warp_field.GetNodePositions(use_virtual_ordering),
	                               warp_field.GetNodeRotations(use_virtual_ordering), warp_anchors, warp_anchor_weights, true);
