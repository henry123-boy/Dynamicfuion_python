...
// Greg Kramida (www.github.com/Algomorph): I modified the file to add CUDA support via Eigen's EIGEN_DEVICE_FUNC macro.
...
void KroneckerProductSparse<Lhs, Rhs>::evalTo(Dest& dst) const {
    ...
    // compute number of non-zeros per inner vectors of dst
    {
...
struct traits<KroneckerProductSparse<Lhs_, Rhs_> > {
    ...
    typedef remove_all_t<Rhs_> Rhs;
    typedef typename ScalarBinaryOpTraits<typename Lhs::Scalar, typename Rhs::Scalar>::ReturnType Scalar;
    typedef typename cwise_promote_storage_type<typename traits<Lhs>::StorageKind, typename traits<Rhs>::StorageKind, scalar_product_op<typename Lhs::Scalar, typename Rhs::Scalar> >::ret
            StorageKind;
    typedef typename promote_index_type<typename Lhs::StorageIndex, typename Rhs::StorageIndex>::type StorageIndex;
    ...
    enum {
        ...
        size_at_compile_time(traits<Lhs>::MaxRowsAtCompileTime, traits<Rhs>::MaxRowsAtCompileTime),
