...
public:
	...
	open3d::core::Tensor GetPoints() const;
	int32_t GetNodeCount() const;

	/// Make a deep copy efficiently
	KdTree Clone() const;

private:
	KdTree(open3d::core::Tensor points, int32_t node_count, std::shared_ptr<open3d::core::Blob> nodes);
