...
class GenericVisualizerApp:
    def __init__(self):
        ...
        chosen_screen_index = 0
        chosen_screen = screens[chosen_screen_index]
        self.render_window.SetPosition(chosen_screen.x, chosen_screen.y)
        self.render_window.SetSize((chosen_screen.width, chosen_screen.height))
...
class BlockVisualizerApp(GenericVisualizerApp):
    def __init__(self):
        super.__init__()
        # set up camera
